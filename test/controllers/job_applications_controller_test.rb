...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference("JobApplication.count") do
      post job_applications_url, params: { job_application: { cover_letter: @job_application.cover_letter, job_listing_id: @job_application.job_listing_id, status: @job_application.status, user_id: @job_application.user_id } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { cover_letter: @job_application.cover_letter, job_listing_id: @job_application.job_listing_id, status: @job_application.status, user_id: @job_application.user_id } }
